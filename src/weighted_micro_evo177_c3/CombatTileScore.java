package weighted_micro_evo177_c3;
...
public class CombatTileScore extends Unit {
    ...
    private static final int KILL_BONUS = 11;
    ...
    private static final int RESCUE_TARGET_BONUS = 19;
    ...
    private static final int COOP_ATTACK_DISCOUNT = 12;
    ...
    private static final int LOW_HEALTH_THRESHOLD = 19;
    ...
    private static final int TRAP_CHEESE_COST = 129;
    ...
    private static final int CHEESE_SCARCE_THRESHOLD = 153;
    ...
    private static final int ENEMY_CARRY_BASE_VALUE = 168;
    ...
    private static final int CAPTOR_DISRUPT_BONUS = 8;
