...
public class Comms extends Unit {
    public static final int slotsNum = GameConstants.SHARED_ARRAY_SIZE;
    public static final int valueMax = GameConstants.COMM_ARRAY_MAX_VALUE;

    // TODO: implement comms
    public static final int ratTargetXSlot = 0;
    public static final int ratTargetYSlot = 1;
    ...
    public static boolean squeak(int contentMessage) throws GameActionException {
        return rc.squeak(contentMessage);
    }

    public static Message[] readRat(){
