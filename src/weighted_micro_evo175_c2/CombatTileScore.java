package weighted_micro_evo175_c2;
...
public class CombatTileScore extends Unit {
    ...
    private static final int KILL_BONUS = 8;
    ...
    private static final int RESCUE_TARGET_BONUS = 24;
    ...
    private static final int COOP_ATTACK_DISCOUNT = 11;
    ...
    private static final int LOW_HEALTH_THRESHOLD = 15;
    ...
    private static final int TRAP_CHEESE_COST = 124;
    ...
    private static final int CHEESE_SCARCE_THRESHOLD = 146;
    ...
    private static final int CARRY_MOBILITY_TAX = 11;
    ...
    private static final int ENEMY_CARRY_BASE_VALUE = 164;
    ...
    private static final int CAPTOR_DISRUPT_BONUS = 13;
