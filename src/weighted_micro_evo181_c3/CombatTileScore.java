package weighted_micro_evo181_c3;
...
public class CombatTileScore extends Unit {
    ...
    private static final int RESCUE_TARGET_BONUS = 28;
    ...
    private static final int COOP_ATTACK_DISCOUNT = 8;
    ...
    private static final int LOW_HEALTH_THRESHOLD = 16;
    ...
    private static final int TRAP_CHEESE_COST = 131;
    ...
    private static final int CHEESE_SCARCE_THRESHOLD = 114;
    ...
    private static final int CARRY_MOBILITY_TAX = 10;
    ...
    private static final int ENEMY_CARRY_BASE_VALUE = 140;
