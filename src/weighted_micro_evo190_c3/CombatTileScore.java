package weighted_micro_evo190_c3;
...
public class CombatTileScore extends Unit {
    ...
    private static final int KILL_BONUS = 5;
    ...
    private static final int TRAP_CHEESE_COST = 136;
    ...
    private static final int CHEESE_SCARCE_THRESHOLD = 212;
    ...
    private static final int CARRY_MOBILITY_TAX = 16;
    ...
    private static final int ENEMY_CARRY_BASE_VALUE = 143;
    ...
    private static final int CAPTOR_DISRUPT_BONUS = 7;
