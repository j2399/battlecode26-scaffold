package weighted_micro_evo176_c3;
...
public class CombatTileScore extends Unit {
    ...
    private static final int KILL_BONUS = 7;
    ...
    private static final int RESCUE_TARGET_BONUS = 29;
    ...
    private static final int COOP_ATTACK_DISCOUNT = 10;
    private static final int COOP_TRAP_DISCOUNT = 2;

    /** Below this HP, retaliation risk is weighted more heavily -- losing
     *  HP matters more the less of it we have left. */
    private static final int LOW_HEALTH_THRESHOLD = 22;
    ...
    private static final int TRAP_CHEESE_COST = 116;
    ...
    private static final int CHEESE_SCARCE_THRESHOLD = 112;
    private static final int CHEESE_SCARCE_TRAP_DISCOUNT = 2;
    ...
    private static final int CARRY_MOBILITY_TAX = 14;
    ...
    private static final int ENEMY_CARRY_BASE_VALUE = 189;
    ...
    private static final int CAPTOR_DISRUPT_BONUS = 10;
    ...
    private static final int COOP_CARRY_DISCOUNT = 2;
