package weighted_micro_evo163_c5;
...
public class CombatTileScore extends Unit {
    ...
    private static final int RESCUE_TARGET_BONUS = 38;
    ...
    private static final int COOP_ATTACK_DISCOUNT = 7;
    ...
    private static final int LOW_HEALTH_THRESHOLD = 18;
    ...
    private static final int TRAP_CHEESE_COST = 108;
    ...
    private static final int CHEESE_SCARCE_THRESHOLD = 100;
    ...
    private static final int ENEMY_CARRY_BASE_VALUE = 228;
